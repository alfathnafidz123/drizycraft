...
const TrialExpired = ({ isOpen, onClose  }: ModalProps) => {
          ...
          <div className="text-center">
            ...
            <div className="mb-2 py-2 space-y-3 text-left text-gray-600 px-14">
              <p className="text-gray-600 font-katide-regular justify-center text-center">
                Don’t stop here! Upgrade to <span className='font-katide-bold'>VIP+</span> and unlock <span className='font-katide-bold'>unlimited downloads</span>  with full premium access today.
              </p>
            </div>
