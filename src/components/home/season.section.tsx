...
import { arrowLefts, arrowRights, halloweenSeason, seasonAutumn } from '~/images';
      ...
      >
        <div className="relative w-full my-8 mx-4 sm:mx-6 lg:mx-8 lg:rounded-2xl overflow-hidden" style={{ backgroundImage: 'linear-gradient(to bottom, #FFE3B3, #ED7737)' }}>
          ...
          <div className="px-4 py-6 sm:px-6 lg:px-8 lg:py-10 mt-8 max-w-full lg:max-w-[60%] text-left lg:text-left flex flex-col lg:items-start">
            ...
            <h1 className="font-katide-extrabold text-[36px] sm:text-[40px] leading-[120%] text-[#1A214C] lg:text-[50px] mt-5 mb-6">
              Hello Cozy Crafts
            </h1>

            <p className="text-[16px] font-katide-regular text-[#1A214C] mb-4 max-w-xl leading-7">
              As the leaves fall and the days turn crisp, craft stories of home, warmth, and handmade magic with our exclusive fall-inspired SVG.
            </p>
          </div>
