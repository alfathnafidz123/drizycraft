      ...
      >
        <div className='h-76 mt-20 w-screen px-4 lg:w-full'>
          <div className='flex w-full flex-col gap-4 lg:h-[600px] lg:flex-row'>
            <div className='relative h-[624px] w-full rounded-2xl border-[20px] lg:h-full lg:w-5/12'>
              <div className='absolute h-full w-full' />
                ...
                <div className='absolute flex h-full w-full flex-col justify-between bg-[#EBECF5]/50 p-4 text-left  text-[#1A214C]'>
                  <div>
                    <p className='font-semibold text-lg lg:text-2xl mb-2'>Projects from crafters</p>
                    <p className='text-sm lg:text-base font-medium'>
                      <span className='block font-semibold'>
                        Have you tried Drizy's designs in your projects?
                      </span>
                      Share your creations in our gallery and earn a valuable Drizy Coin for more shopping!
                    </p>
                  </div>
                  ...
                  <div className='mt-4 flex w-full flex-col gap-4'>
                    <div className='flex items-center gap-2'>
                      <NextImage
                        ...
                        height={56}
                        src={leslie.src}
                        className='rounded-full border-[3px] border-white h-10 w-10 lg:h-14 lg:w-14'
                    ...
                    <Link
                      href='/project'
                      prefetch={false}
                      className='flex h-14 w-full items-center justify-between rounded-full bg-[#1A214C] pl-4'
                    >
