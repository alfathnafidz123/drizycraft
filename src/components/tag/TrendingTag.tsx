...
const TrendingTag = ({ name, onClick }: TrendingTagProps) => {
  return (
    <div className='font-katide-bold group flex items-center rounded-full border border-[#8BC0E7] text-[10px] text-[#4065D1]' onClick={onClick}>
      <img
        src={searchBlue.src}
