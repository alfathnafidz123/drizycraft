          ...
          <ul className='hidden space-x-[30px] lg:flex'>
            {navigationLinks.map((nav, i) => (
              <li key={i} className=''>
                <Link
                  href={nav.hash}
                  className="before:origin-[100%, 50%] before:scale-z-[1] hover:before:origin-[100%, 0%] hover:before:scale-z-[1] relative pb-2 text-[12px] text-[#0151c6] font-semibold uppercase tracking-[2px] before:absolute before:bottom-0 before:left-0 before:h-[2px] before:w-full before:scale-x-0 before:scale-y-[1] before:bg-[#0151c6] before:transition-all before:duration-300 before:ease-in-out before:will-change-transform before:content-[''] hover:before:scale-x-[1] hover:before:scale-y-[1]">
                  {nav.name}
                </Link>
              </li>
            ))}
