...
import {
  ...
  backgroundMembership2, bfBanner, bfBgBanner, bfBgBannerLeft, bfBgBannerRight, bgBgSlider,
  checkblue,
  crossMember,
  drizzyCoin,
  leftMembership,
...
export default function Membership() {
  ...
  const subscriptionPlans = [
    ...
    },
    {
      ...
      text: "<p><br/>Unlock a year of <strong>Unlimited Crafting!</strong> Now at our Black Friday Price! <br/><br/>Get every benefits for just $50 for the entire year. This is the lowest price we've ever offered. <br/></p>",
      coin: (
        <p className='text-sm'>
  ...
  const productsMembership = [
    { id: 1, image: 'https://drizycraft.com/_next/image?url=https%3A%2F%2Fmedia.drizycraft.com%2F2025%2F10%2F01%2F1-b37c.jpg&w=750&q=70' },
    { id: 2, image: 'https://drizycraft.com/_next/image?url=https%3A%2F%2Fmedia.drizycraft.com%2F2025%2F10%2F02%2F1-b273.jpg&w=750&q=70'},
    { id: 3, image: 'https://drizycraft.com/_next/image?url=https%3A%2F%2Fmedia.drizycraft.com%2F2025%2F10%2F03%2F1-1c6f.jpg&w=750&q=70'},
    { id: 4, image: 'https://drizycraft.com/_next/image?url=https%3A%2F%2Fmedia.drizycraft.com%2F2025%2F10%2F06%2F1-e66a.jpg&w=750&q=70'},
    { id: 5, image: 'https://drizycraft.com/_next/image?url=https%3A%2F%2Fmedia.drizycraft.com%2F2025%2F10%2F07%2F1-5a08.jpg&w=750&q=70'},
    { id: 6, image: 'https://drizycraft.com/_next/image?url=https%3A%2F%2Fmedia.drizycraft.com%2F2025%2F10%2F13%2F1-6be7.jpg&w=750&q=70'},
    { id: 7, image: 'https://drizycraft.com/_next/image?url=https%3A%2F%2Fmedia.drizycraft.com%2F2025%2F10%2F20%2F1-bc5b.jpg&w=750&q=70'},
    { id: 8, image: 'https://drizycraft.com/_next/image?url=https%3A%2F%2Fmedia.drizycraft.com%2F2025%2F10%2F31%2F1-bfab.jpg&w=750&q=70'},
    { id: 9, image: 'https://drizycraft.com/_next/image?url=https%3A%2F%2Fmedia.drizycraft.com%2F2025%2F11%2F13%2F1-c4ed.jpg&w=750&q=70'},
    { id: 10, image: 'https://drizycraft.com/_next/image?url=https%3A%2F%2Fmedia.drizycraft.com%2F2025%2F11%2F17%2F1-c187.jpg&w=750&q=70'},
  ...
  return (
    <main>
        ...
        <section className="relative lg:static flex flex-col items-center justify-end gap-8 px-4 pt-32 lg:pt-20 pb-20 lg:px-0 overflow-hidden">
          <div className="absolute inset-0 z-10">
            <Image
              src={bfBgBanner}
              alt="Background 1"
              className="h-full lg:h-auto w-full object-cover opacity-100 pointer-events-none"
              priority
            />
          </div>
          ...
          <div className="absolute inset-0 z-10">
            <Image
              src={bfBgBanner}
              alt="Background 2"
              className="h-full lg:h-auto object-cover opacity-15 mix-blend-overlay pointer-events-none"
            />
            {/*<div className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-white to-transparent z-10" />*/}
          </div>

          <div className="absolute top-2 left-[-10px] lg:top-[150px] lg:left-[-15px] lg:pr-[800px] z-20 ">
              <Image
                src={bfBgBannerLeft}
                alt="Left Membership"
                className="h-[200px] sm:h-[140px] md:h-[280px] lg:h-auto lg:max-h-[850px] w-auto lg:w-[600px] object-contain pointer-events-none "
              />
          </div>
          <div className="absolute top-2 right-[-10px] lg:top-[150px] lg:right-[-15px] lg:pl-[800px] z-20">
              <Image
                src={bfBgBannerRight}
          ...
          <div className="z-20 max-w-[1000px] text-center sm:pt-24 md:pt-32 lg:pt-0">
              <Image src={bfBanner} alt="banner" className="lg:max-w-[800px] lg:min-w-[700px] h-full"/>
          </div>
        </section>

        {/* Card Membership  */}
        <section className='relative flex flex-col items-center justify-center text-[#1A214C] pt-10 bg-[#33005C]'>
          {/* LINE 1 */}
          <div className="z-20 absolute inset-0 flex items-center justify-start rotate-[-5deg] pointer-events-none translate-y-[-140px] md:translate-y-[-200px] lg:translate-y-[-180px]">
            <div className="flex min-w-[400%] lg:min-w-0 animate-infiniteSliderSlow">
              {[...Array(5)].map((_, i) => (
                <Image
                  key={i}
                  src={bgBgSlider}
          ...
          {/* LINE 2 */}
          <div className="z-20 absolute inset-0 flex items-center justify-start rotate-[-5deg] pointer-events-none ">
            <div className="flex min-w-[400%] lg:min-w-0 animate-infiniteSliderMedium">
              {[...Array(5)].map((_, i) => (
                <Image
                  key={i}
                  src={bgBgSlider}
          ...
          {/* LINE 3 */}
          <div className="z-20 absolute inset-0 flex items-center justify-start rotate-[-5deg] pointer-events-none translate-y-[140px] md:translate-y-[200px] lg:translate-y-[180px]">
            <div className="flex min-w-[400%] lg:min-w-0 animate-infiniteSliderFast">
              {[...Array(5)].map((_, i) => (
                <Image
                  key={i}
                  src={bgBgSlider}
          ...
          <div className=' z-20 relative flex w-full flex-col items-center lg:max-w-[1264px]'>

            <div className='relative flex flex-col flex-wrap items-center justify-center rounded-lg lg:border border-[#FFBB3C] p-2 lg:p-12 mb-12 sm:border-0' style={{ borderRadius: '24px' }}>
              {/* Badge Image at Top */}
              ...
              <div className='flex w-full flex-col justify-center lg:flex-row gap-10 lg:gap-9 max-lg:px-8 mt-28 lg:mt-20'>
                {subscriptionPlans.map((plan, index) => (
                  <div
                    key={index}
                    className={`rounded-2xl shadow-2xl shadow-[#00000033] max-md:min-h-[400px] max-md:w-[280px] lg:!min-h-[1020px] lg:w-2/5 relative group border-white hover:border-[#EE4C73] transition-all max-sm:p-2 max-sm:shadow-2xl ${
                  ...
                  >
                    ...
                    {plan.duration === "BASIC 1 MONTH" && (
                      <div className='bg-[#E4F6FB] w-full h-36 absolute top-0 left-0 rounded-2xl z-10' />
                    )}

                    {/* Best Value Badge */}
                    {plan.duration === "ANNUAL ACCESS" && (
                      <div className='bg-[#D1DD35] w-full h-36 absolute -top-14 left-0 rounded-2xl text-center pt-2 flex flex-col'>
                        <span className='font-katide-bold text-[#61657D] tracking-widest h-5'>LIMITED TIME !</span>
                        <span className='font-katide-heavy text-lg text-[#1A214C]'>SAVE 33%</span>
                      </div>
                    )}
                    ...
                    <div className="flex flex-col rounded-2xl p-2 lg:p-6 z-10 w-full ">
                      ...
                      {/* Features Included */}
                      <div className='hidden lg:flex flex-col gap-3.5 mx-auto px-16 mt-6'>
        ...
        {/* Product slide  */}
        <section className="bg-[#33005C] py-8 px-4 overflow-hidden">
          <h2 className="text-3xl font-normal text-center my-16 text-white">
        ...
        {/* Features  */}
        <section className="bg-[#33005C] pt-8 md:pb-8 overflow-hidden">
