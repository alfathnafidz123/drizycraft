    ...
    <main>
      <section className='flex flex-col gap-12 px-24 py-16'>
        ...
        <div className='flex gap-8'>
          ...
          <div className='flex basis-1/3 flex-col gap-16'>
            <p className='text-2xl font-semibold text-[#1A214C]'>
              Romantic Couple 3D Shadow Box – Valentine’s 3D Shadow Box
            </p>
            <p className='text-6xl font-semibold text-[#1A214C]'>$3</p>
            <div className='flex flex-col gap-4'>
              <p className='text-lg font-semibold text-[#1A214C]'>
                License Option
              </p>
              <div className='flex justify-between gap-2'>
                <button className='rounded-full border-2 border-[#C7C7C7] bg-[#008ECC] px-10 py-2 font-semibold text-[#e4f6fb]'>
                  Personal
                </button>
                <button className='rounded-full border-2 border-[#C7C7C7] bg-[#E4F6FB] px-10 py-2 font-semibold text-[#A1A1A1]'>
                  Commercial
                </button>
                <button className='rounded-full border-2 border-[#C7C7C7] bg-[#E4F6FB] px-10 py-2 font-semibold text-[#A1A1A1]'>
                  Business
              ...
              <button className='w-full rounded-full bg-[#1A214C] px-10 py-2 font-semibold text-[#e4f6fb]'>
                Add to cart
              </button>
              ...
              <ul className='list-disc text-lg text-[#1A214C]'>
      ...
      <section className='flex gap-8 bg-[#EBECF5] px-24 py-16'>
        <div className='flex basis-2/3 flex-col gap-8'>
          <p className='text-2xl font-semibold text-[#1A214C]'>
            Product Detail
          </p>
          <p className='text-2xl font-semibold text-[#707070]'>
            Romantic Couple 3D Shadow Box – Valentine’s 3D Shadow Box
          </p>
          <div className='text-2xl font-light text-[#707070]'>
            ...
            <br />
            The SVG file is included to cut the design with Silhouette, Cricut,
            and other cutting machines. You can use your art knife and scissors
            if you do not have one. Glue or double-sided tape is needed to
            assemble the design. SVG files can be resized, but you must keep the
            same aspect ratio. You can frame it as wall decoration or use it as
            a lightbox by adding LED strips between layers for a special effect.
            It will make a great gift for a friend, your family, or someone
            special. <br />
            <br />
            NOTE: The images are for preview purposes only. The final product
            color may vary slightly due to lighting sources and the paper color.
            <br />
            <br />
        ...
        <div className='mt-16 basis-1/3 rounded-3xl bg-white p-8 shadow-xl'>
          ...
          <div className='relative w-full'>
            ...
            <div className='absolute bottom-0 left-0 rounded-full border-2 border-[#1A214C] bg-white px-4 py-2 text-[#1A214C]'>
              Load more
            </div>
          </div>
        </div>
