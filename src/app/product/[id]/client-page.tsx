    ...
    <>
      <main>
        <ModalAddReview
          ...
          refreshStar={getSummaryReview}
          productId={productData.product?.id}
        />
        <section className='mx-auto flex w-full max-w-[1164px] flex-col gap-12 max-md:p-6 lg:pt-16 lg:pb-8'>
          ...
          <div className='grid gap-4 lg:grid-cols-8'>
              ...
              <div className='grid grid-cols-1 lg:grid-cols-8'>
                ...
                {productData && (
                  <div className='w-full relative order-first lg:col-span-7'>
                    ...
                    }} className='absolute right-5 top-[45%] z-10 bg-black/40 p-2 rounded-full'>
                    ...
                    }} className='absolute left-5 top-[45%] z-10 bg-black/40 p-2 rounded-full'>
            ...
            <div className='flex flex-col items-start gap-10 lg:col-span-3 lg:pl-6'>
              <h1 className='text-2xl font-semibold text-[#1A214C]'>
                {productData.product?.name}
              </h1>
        ...
        <section className='flex flex-col gap-8 bg-[#EBECF5] max-md:p-6 lg:py-16'>
